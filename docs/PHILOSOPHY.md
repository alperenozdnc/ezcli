...
i always go through this with my own projects, or when i see neatly done
...
personally, i hate libraries with so much abstraction it feels like you're
writing python. the programmer doesn't need that much hand-holding. i mean
...
too many opinions bundled in something that many people use isn't always nice.
...
it's not descriptive anymore. storing information in strings is done with yml,
